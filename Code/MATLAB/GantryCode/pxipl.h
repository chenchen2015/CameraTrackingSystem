/*
 *
 *	pxipl.h 	External	24-Jul-2012
 *
 *	Copyright (C)  1988-2012  EPIX, Inc.  All rights reserved.
 *
 ...
 * pxi8spo.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_pixmap   (pxabortfunc_t**,pximage_s *sip,pximage_s *dip,uchar *map,size_t nmap);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_pixmaps  (pxabortfunc_t**,pximage_s *sip,pximage_s *dip,uint16 *map,size_t nmap);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_pixmapl  (pxabortfunc_t**,pximage_s *sip,pximage_s *dip,uint32 *map,size_t nmap);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxipf_pixcontrast(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,double lowbound,double highbound);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_pixiecopy(pxabortfunc_t**,pximage_s *sip,pximage_s *dip, uint pixiesrc, uint pixiedstmap);
 ...
 * pxi8set.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_pixset(pxabortfunc_t**,pximage_s *dip,uint32 value);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_noiseadd(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,int type,uint32 seed,double mean, double variance,double parm0,double parm1);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_copyconvert(pxabortfunc_t**,pximage_s *sip,pximage_s *dip, int xsb, int xflt, int rsvd3, int rsvd4);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_copyslice(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,int spixie,int dpixie);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_copycolorconvert(pxabortfunc_t**,pximage_s *sip,pximage_s *dip, int rsvd1, int newhint, int rsvd2, int rsvd3);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxipf_pairratio(pxabortfunc_t**,pximage_s *s1p,pximage_s *s2p,pximage_s *dip,int mode,double coef[]);
_cDcl(_dllpxipl,_cfunfcc,int) pxipf_pairprod(pxabortfunc_t**,pximage_s *s1p,pximage_s *s2p,pximage_s *dip,int mode,double coef[]);
_cDcl(_dllpxipl,_cfunfcc,int) pxipf_pairoverlay(pxabortfunc_t**,pximage_s *s1p,pximage_s *s2p,pximage_s *dip,int mode,double key[]);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_tripletnormalize(pxabortfunc_t**,pximage_s *s1p,pximage_s *s2p,pximage_s *s3p,pximage_s *dip,uint32 targetvalue,int mode);
...
typedef struct pxip8pat pxip8pat_s;
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_patterncos(pxabortfunc_t**,pximage_s *ip,pxip8pat_s *p);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_patterngaussian(pxabortfunc_t**,pximage_s *ip,pxip8pat_s *p);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_patternfiducial(pxabortfunc_t**,pximage_s *ip,pxip8pat_s *pp,
			uint background[],uint foreground[],int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_patterns(pxabortfunc_t**,pximage_s *ip,pxip8pat_s *p,int type);
 ...
 */
#include "pximregn.h"
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_masscenterbin(pxabortfunc_t**,pximregion_s *rp,ulong *area,ulong *xsum,ulong *ysum,int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_masscenter(pxabortfunc_t**,pximregion_s *rp,double *mass,double *xcenter,double *ycenter);
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_masscenterpow(pxabortfunc_t**,pximregion_s *rp,double *mass,double *xcenter,double *ycenter,double pow, int rsvd);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_masscenterbin(pxabortfunc_t**,pximage_s *ip,ulong *area,ulong *xsum,ulong *ysum);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_masscenter(pxabortfunc_t**,pximage_s *ip,double *mass,double *xcenter,double *ycenter);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_masscenterpow(pxabortfunc_t**,pximage_s *ip,double *mass,double *xcenter,double *ycenter,double pow, int rsvd);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_histab2(pxabortfunc_t**,pximage_s *ip,pxim2size_t *count,size_t ncount);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_histab3(pxabortfunc_t**,pximage_s *ip,pxim2size_t *count,size_t ncount,int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_histabpair(pxabortfunc_t**,pximage_s *s1p,pximage_s *s2p,pxim2size_t *count,size_t ncount,int mode);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_histstatf(pxip8histab_s *hp,
			...
			pxip8histperc_s *pp);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_histstat2(pximage_s *ip,pxim2size_t *count,size_t ncount,
			pxip8histstat_s *sp,pxip8histperc_s *pp);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_histstat2f(pximage_s *ip,pxim2size_t *count,size_t ncount,
			double (_cfunfcc *mapzifunc)(void *,pxyd_s *,double),
			void *mapfuncrefp,pxip8histstat_s *sp,
			pxip8histperc_s *pp);
 ...
 * pxi8drpi.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_drawpincushionbox(pxabortfunc_t**,pximage_s *ip,pxywindow_s *wp,pxy_s *xyp,
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_ilacelinetoNfield(pxabortfunc_t**,pximage_s *ip,pximage_s *op, int nfield);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_ilaceNfieldtoline(pxabortfunc_t**,pximage_s *ip,pximage_s *op, int nfield);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_geotranrotate2(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_geotranpincushion(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,
...
_cDcl(_dllpxipl,_cfunfcc,int) pxirp_regionarea(pximregion_s *rp,pxim2size_t *areap,int mode);
 ...
 * pxrpreg6.c
 */
_cDcl(_dllpxipl,_cfunfcc,int)  pxirp_regionexport(pxabortfunc_t**,pximregion_s *srp,const char *pathname,const char *filemode);
_cDcl(_dllpxipl,_cfunfcc,int)  pxirp_regionimport(pxabortfunc_t**,pximregion_s **srpp,const char *pathname,const char *filemode);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_histab2(pxabortfunc_t**,pximregion_s *rp,pxim2size_t *count,size_t ncount);
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_histab3(pxabortfunc_t**,pximregion_s *rp,pxim2size_t *count,size_t ncount,int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_histabpair(pxabortfunc_t**,pximregion_s *r1p,pximregion_s *r2p,pxim2size_t *count,size_t ncount,int mode);

/*
 * pxr8spo.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_pixmap(pxabortfunc_t**,pximregion_s *srp,pximregion_s *drp,uchar *map,size_t nmap);
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_pixmaps(pxabortfunc_t**,pximregion_s *srp,pximregion_s *drp,uint16 *map,size_t nmap);
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_pixmapl(pxabortfunc_t**,pximregion_s *srp,pximregion_s *drp,uint32 *map,size_t nmap);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxirpf_pixcontrast(pxabortfunc_t**,pximregion_s *sip,pximregion_s *dip,
...
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_pixiecopy(pxabortfunc_t**,pximregion_s *sip,pximregion_s *dip, uint pixiesrc, uint pixiedstmap);
 ...
 * pxr8set.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_pixset(pxabortfunc_t**,pximregion_s *dip,uint32 value);
 ...
 */
#include <sys/types.h>
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binread(pxabortfunc_t**,pximage_s *ip,const char *pathname, off_t skip);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binwrite(pxabortfunc_t**,pximage_s *ip,const char *pathname);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_bin1read(pxabortfunc_t**,pximage_s *ip,const char *pathname,int mode, off_t skip);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_bin1write(pxabortfunc_t**,pximage_s *ip,const char *pathname,int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binreadseq(pxabortfunc_t**,pximage3_s *ip,const char *pathname, int mode, off_t skip1, off_t skip2);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binwriteseq(pxabortfunc_t**,pximage3_s *ip,const char *pathname, int emode);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_bin1writeseq(pxabortfunc_t**,pximage3_s *ip,const char *pathname,int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_bin1readseq(pxabortfunc_t**,pximage3_s *ip,const char *pathname,int mode, off_t skip1, off_t skip2);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binwriteseqinit(pxabortfunc_t**,void **handlep,const char *pathname,pximage_s *ip,int mode,int rsvd1,int rsvd2,long nimages);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binwriteseqadd(pxabortfunc_t**,void **handlep,const char *pathname,pximage_s *ip);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_binwriteseqdone(pxabortfunc_t**,void **handlep,const char *pathname);


/*
 * pxio8hex.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_hexread(pxabortfunc_t**,pximage_s *ip,const char *pathname);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_hexwrite(pxabortfunc_t**,pximage_s *ip,const char *pathname,char linedelim);


/*
 * pxio8inf.c
 */
_cDcl(_dllpxipl,_cfunfcc,int)	pxio8_fileinfo(const char *pathname,pximfileinfo_s *infop,long subfile,int mode);
_cDcl(_dllpxipl,_cfunfcc,int)	pxio8_fileinfoN(const char *pathname,pximfileinfo_s info[],size_t infoN, long subfile,int mode);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_tifreadseq(pxabortfunc_t**,pximage3_s*ip,pximage_s *lip,
				    const char *pathname,long subfile,pxywindow_s *windp,int mode);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_tifwriteseqinit(pxabortfunc_t**,void **handlep,const char *pathname,pximage_s *ip,
				    pximage_s *lutip,int ipbits,int lutbits,pximfileinfo_s *parmp,long nimages);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_tifwriteseqadd(pxabortfunc_t**,void **handlep,const char *pathname,pximage_s *ip,
				    pximage_s *lutip,int ipbits,int lutbits,pximfileinfo_s *parmp);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_tifwriteseqdone(pxabortfunc_t**,void **handlep,const char *pathname);
...
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_avireadseq(pxabortfunc_t**,pximage3_s *ip,pximage_s*lip,
			const char *pathname,long subfile,pxywindow_s *windp,int mode);
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviwriteseqinit(pxabortfunc_t**,void **handlep,const char *pathname,
			pximage_s *ip,pximage_s *lip,int bits,pximfileinfo_s *parmp,long nimages);
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviodmlwriteseqinit(pxabortfunc_t**,void **handlep,const char *pathname,
			pximage_s *ip,pximage_s *lip,int bits,pximfileinfo_s *parmp,long nimages);
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviwriteseqadd(pxabortfunc_t**,void **handlep,const char *pathname,
			pximage_s *ip,pximage_s *lip,int bits,pximfileinfo_s *parmp);
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviwriteseqdone(pxabortfunc_t**,void **handlep,const char *pathname);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_jpegwrite2(pxabortfunc_t**,pximage_s*ip,void *rsvd,const char *pathname,
 ...
 * pxio8asc.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_asciiwrite(pxabortfunc_t**,pximage_s *ip,const char *pathname,char coldelim,char linedelim,int maxpixline);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_asciiread(pxabortfunc_t**,pximage_s *ip,const char *pathname,char linedelim);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_asciiwriteseq(pxabortfunc_t**,pximage3_s *ip,const char *pathname,char coldelim,char linedelim,char imagedelim,int maxpixline);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_asciireadseq(pxabortfunc_t**,pximage3_s *ip,const char *pathname,char linedelim,char imagedelim);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_asciiwritecoord(pxabortfunc_t**,pximage_s *ip,const char *pathname,char*header,uint mask,char coldelim,char linedelim,int aoiorigin,int mode,pxim2size_t *cntp);
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_asciireadcoord(pxabortfunc_t**,pximage_s *ip,const char *pathname,uint mask,char commentdelim,char linedelim,int aoiorigin,int mode,pxim2size_t *cntp);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_xlacecolumntoNsection(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,int mode,int nsection);
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_xlaceNsectiontocolumn(pxabortfunc_t**,pximage_s *sip,pximage_s *dip,int mode,int nsection);
 ...
 * pxipefit.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip_fitconic(pxyd_s points[],size_t npoints,int mode,double coniccoef[6]);
_cDcl(_dllpxipl,_cfunfcc,int) pxip_fitellipse(pxyd_s points[],size_t npoints,int mode,pxyd_s ellipse[3],double coniccoef[6]);
_cDcl(_dllpxipl,_cfunfcc,int) pxip_fithyperbola(pxyd_s points[],size_t npoints,int mode,pxyd_s ellipse[3],double coniccoef[6]);

/*
 * pxi8cnt.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_pixthresholdcnt(pxabortfunc_t**,pximage_s *ip,uint32 threshold,int mode,pxim2size_t *cntp);
_cDcl(_dllpxipl,_cfunfcc,int) pxipf_pixthresholdcnt(pxabortfunc_t**,pximage_s *ip,double threshold,int mode,pxim2size_t *cntp);

/*
 * pxr8cnt.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxirp8_pixthresholdcnt(pxabortfunc_t**,pximregion_s *rp,uint32 threshold,int mode,pxim2size_t *cntp);
_cDcl(_dllpxipl,_cfunfcc,int) pxirpf_pixthresholdcnt(pxabortfunc_t**,pximregion_s *rp,double threshold,int mode,pxim2size_t *cntp);
...
_cDcl(_dllpxipl,_cfunfcc,int) pxio8_print(pxabortfunc_t**,pximage_s *ip,struct pxio8print *pp,
		 int (_cfunfcc *printfunc)(void *statep, uchar *datap, size_t n),
		 void *funcstatep);
 ...
 * pxippart.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip_particleflow(pxabortfunc_t**,int ant,struct pxip8blob *ablobs[],size_t anblob[],
...
/*
 * Following impure, frame grabber dependent, misfits need pxdlib.h
 */
#if !defined(C_TMSC40)
...
_cDcl(_dllpxipl, _cfunfcc, int) pxio8_vgawaterfall(pxabortfunc_t**,
		uint32 (_cfunfcc *vbtimefunc)(void *),void *vbtimefuncrefp, pximage_s *ip,
 ...
 * pxi8blnd.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_blend(pxabortfunc_t**,pximage_s *sip,pximage_s *dip, int mode);
