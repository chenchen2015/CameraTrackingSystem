/*
 *
 *	pxlibvs.h	External	18-Jun-2014
 *
 ...
 */
    ...
    /*
     * The pxbuffer_t has long been synonymous to 'long';
...
struct pxvidstate {
     ...
     */
    struct {	/* PIXCI(R) frame grabbers	    */
	//struct  xcsv2format	  *sv2format;
	//struct  xcsv2mode	  *sv2mode;
	union	xcanalogformat	*anaformat;
	union	xcanalogmode	*anamode;
	struct	xcdxxformat	*dxxformat;
    } xc;

    struct {	/* SILICON VIDEO(R) frame grabbers  */
		/* (not to be confused with SILICON */
		/* VIDEO cameras)		    */
	struct	svformat    *format;
    } sv;

    struct {	/* 4MEG VIDEO(tm) frame grabbers    */
...
struct	pxvidformat {
	...
	int	pixdopes[PXMAX_LOVC];	/* internal			    */
			    ...
			    /* PIXCI SV7				    */
			    /* PIXCI A310/A110				    */
			    /* PIXCI D/D24/D32/D2X/CL1/CL2/E1/E4/E1DB/EL1DB */
			    /*	     /E4DB/EC1/EB1/EB1-PoCL/ECB1/ECB1-34    */
			    /*	     /ECB2/EL1/SI/SI1/SI2/SI4/E8/E8CAM	    */
			    /*	     /E8DB/e104x4/EB1mini/E4G2: 	    */
...
struct	pxviddim {	    /* common control over x and y			    */
    ...
    int     vidsamples;     /* video pixels per line/column			    */
			    ...
			    /* XC D/D24/D32/A/A110/A310/D2X/CL1/CL2/E1/E4/E8/E1DB/EL1DB  */
			    /*	  /E4DB/EB1/EB1PoCL/EC1/ECB1/ECB1-34/ECB2/EL1	    */
			    /*	  /E8CAM/E8DB/e104x4/EB1mini/E4G2		    */
...
struct	pxvidres {
	...
	int	setpixbits;	/* 0|1|2: force pixies/pixhint/pixiebits to max 	*/
			    ...
			    /* CL2/E1/E4/EB1/EB1PoCL/EC1/ECB1/ECB1-34/ECB2/EL1/E1DB	*/
			    /* /EL1DB/E4DB/E8/E8CAM/E8DB/e104x4/EB1mini/E4G2		*/
			    /* uses both dat.* and vid.*				*/
...
#if  defined(OS_WINNT)|defined(OS_WINNT_DLL)|defined(OS_WINNT_UMDF) \
...
typedef struct pxvidphys_thunk6432 pxvidphys_thunk6432_s;
...
struct pxvidmem_thunk3264 {
    struct  pxddch  ddch;

    uint64	space[PXMAX_UNITS];
    uint64	start[PXMAX_UNITS];
    uint64	length[PXMAX_UNITS];	/* may be larger than memory size to indicate all   */
    uint64	rsvd[PXMAX_UNITS];
};

struct pxvidmem_thunk6432 {
    struct  pxddch  ddch;
...
struct pxcamcntl {
    ...
    //
    // Mid V3.7 change. The pxcamcntl is now a variable length struct,
    // with a variable length cntldata. The ddch.len specifies the size
    // of the entire struct, and implies the size of cntldata.
    // This was the historic size, and remains the minimum size.
    // 11-May-2011
    //
    union {
	uint32	 data32[128];
