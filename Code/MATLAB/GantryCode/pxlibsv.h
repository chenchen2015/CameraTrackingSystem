/*
 *
 *	pxlibsv.h	External	10-May-2011
 *
 ...
 */
    ...
    |defined(OS_WINNT)|defined(OS_WINNT_KMD)|defined(OS_WINNT_DLL)|defined(OS_WINNT_UMDF)|defined(OS_WINNT_WDM) \
    |defined(OS_WIN64)|defined(OS_WIN64_DLL)|defined(OS_WIN64_WDM)|defined(OS_WIN64_UMDF)
...
struct pxasync {
	...
	void		*statep;
	  ...
	  |defined(OS_WINNT)|defined(OS_WINNT_DLL)|defined(OS_WINNT_UMDF)|defined(OS_WINNT_KMD)|defined(OS_WINNT_WDM) \
	  |defined(OS_WIN64)|defined(OS_WIN64_DLL)|defined(OS_WIN64_UMDF)|defined(OS_WIN64_WDM)
	HANDLE	*hEvent;
    #elif defined(OS_LINUX)
	int	sig;
	void	*rsvd;
...
struct pxlibservice {
    ...
    int (_cfunfcc *allocStateCopy)    (pxlibservice_s *me,int options,int stateid,pxvidstate_s **statepp);    // stateid ignored!
    int (_cfunfcc *freeStateCopy)     (pxlibservice_s *me,int options,int stateid,pxvidstate_s **statepp);    // stateid ignored!
  ...
  //int (_cfunfcc *copyStateCopy)     (pxlibservice_s *me,int options,int stateid,pxvidstate_s *statep,pxvidstate_s *state2p);	// stateid ignored!
    int (_cfunfcc *rsvd0)	      (pxdevservice_s *me);
    ...
    /*
     * More Video state management, supporting variable length
     * components of video state.
     */
    int (_cfunfcc *getAllocState)	   (pxlibservice_s *me,int options,int stateid,pxvidstate_s **statepp);

    /*
     * More video state utilities, supporting variable length
     * components of video state.
     */
    int (_cfunfcc *importAllocStateCopy)   (pxlibservice_s *me,int options,int stateid,pxvidstate_s **statepp,int stateindex,const char *pathname,char *filemode);
    int (_cfunfcc *initAllocStateCopy)	   (pxlibservice_s *me,int options,int stateid,pxvidstate_s **statepp,pxdevinfo_s *infop,const char *formatname,int vidmode); // stateid ignored!
...
struct pxauxservice {
     ...
     * and file formats.
     */
    int (_cfunfcc *imageLoadBmp)    (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *pathname,int loadmode);
    int (_cfunfcc *imageSaveBmp)    (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *pathname,int savemode);
    int (_cfunfcc *imageSaveTga)    (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *pathname,int savemode);
    int (_cfunfcc *imageSavePcx)    (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *pathname,int savemode);
    int (_cfunfcc *imageLoadTiff)   (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *pathname,int loadmode);
    int (_cfunfcc *imageSaveTiff)   (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *pathname,int savemode);
     ...
     */
    int (_cfunfcc *bufferSaveStream) (pxauxservice_s *me,pxabortfunc_t**,int options,int unitmap,int stateid,pxbuffer_t startbuf,pxbuffer_t endbuf,
				      const char *pathname,void *filehandle,pxbuffer_t fileoffset,uint32 alignsector, uint32 rsvd2, uint32 rsvd3);
    int (_cfunfcc *bufferLoadStream) (pxauxservice_s *me,pxabortfunc_t**,int options,int unitmap,int stateid,pxbuffer_t startbuf,pxbuffer_t endbuf,
				      const char *pathname,void *filehandle,pxbuffer_t fileoffset,uint32 alignsector, uint32 rsvd2, uint32 rsvd3);
    int (_cfunfcc *bufferSaveStreamInit) (pxauxservice_s *me,pxabortfunc_t**,int options,int unitmap,int stateid,pxbuffer_t startbuf,pxbuffer_t endbuf,
				      const char *pathname,void *filehandle,pxbuffer_t fileoffset,uint32 alignsector);	 // future?
    int (_cfunfcc *bufferSaveStreamAdd)  (pxauxservice_s *me,pxabortfunc_t**,int options,int unitmap,int stateid,pxbuffer_t startbuf,pxbuffer_t endbuf,
				      const char *pathname,void *filehandle,pxbuffer_t fileoffset,uint32 alignsector);	 // future?
    int (_cfunfcc *bufferSaveStreamDone) (pxauxservice_s *me,pxabortfunc_t**,int options,int unitmap,int stateid,pxbuffer_t startbuf,pxbuffer_t endbuf,
				      const char *pathname,void *filehandle,pxbuffer_t fileoffset,uint32 alignsector);	 // future?
    ...
    #elif defined(OS_WINNT_UMDF)|defined(OS_WIN64_UMDF)
