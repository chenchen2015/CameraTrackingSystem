...
%% Triangulate and get projected world points (camera coordinates)
...
%% This is a trained Neural Network with all the 33 input pairs, it will
% reproject world points (with camera coordinates) to Gantry points
% Chen Chen
