/*
 *
 *	xclibex2.cpp	External	18-Jun-2014
 *
 *	Copyright (C)  1998-2014  EPIX, Inc.  All rights reserved.
 *
 *	Example program for the XCLIB 'C' Library.
 *	Example assumes Windows 95/98/ME/NT/2000/XP/Vista/7/8 32/64-Bit.
 *
 *	Has dialog controls for PIXCI(R) SV2/SV3/SV4/SV5/SV5A/SV5B/SV5L/SV7/SV8.
 ...
 */
  ...
  #define FORMATFILE_LOAD   "Default.fmt"  // .. loaded from file during execution
  //#define FORMATFILE_COMP   "Default.fmt"  // .. or compiled into this application
#endif
 ...
 *
 */
#define UNIT0BITMASK	1
#define UNIT1BITMASK	2
#define UNIT2BITMASK	4
#define UNIT3BITMASK	8

#if !defined(UNITS)
    #define UNITS	3
#endif
//#define UNITSMAP    ((1<<UNITS)-1)  /* shorthand - bitmap of all units */
#define UNITSMAP    ( UNIT0BITMASK | UNIT2BITMASK | UNIT3BITMASK )  /* shorthand - bitmap of all units */
 ...
 */
    ...
    #define UPDATE_TIMER    1	// Use timer to periodically poll library
				...
				// and events.
    #define UPDATE_EVENT    1	// Use an event to trigger display of new image.
 ...
 *
 *	Either (XCLIB w/out PXIPL for Windows XP/Vista/7/8 64-Bit
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\XCLIBW64.LIB" tt.res @t1 @t2
 *	or  (XCLIB+PXIPL for Windows XP/Vista/7/8 64-Bit
 ...
 *    as a Windows NT/2000/XP/Vista/7/8 Win32 Platform or Win64/x64 Platform app,
 ...
 *
 *  4c) Compile with Microsoft Visual C/C++ V6.0 for Windows NT/2000/XP/Vista/7/8 32-Bit as:
 *
 *	    cl -I "\Program Files\EPIX\XCLIB" -c xclibex2.cpp
 *	    rc.exe /l 0x409 /fo tt.res	"\Program Files\EPIX\XCLIB\xclibex2.rc"
 *	    echo -subsystem:windows,4.0 -entry:WinMainCRTStartup comdlg32.lib ole32.lib >t1
 ...
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\XCLYBWNT.LIB" tt.res @t1 @t2
 *
 *  4d) Compile with Microsoft Visual C/C++ VS2005 for Windows NT/2000/XP/Vista/7/8 32-Bit as:
 *
 *	    cl -I "\Program Files\EPIX\XCLIB" -c xclibex2.cpp
 *	    rc.exe /l 0x409 /fo tt.res	"\Program Files\EPIX\XCLIB\xclibex2.rc"
 *	    echo -subsystem:windows,4.0 -entry:WinMainCRTStartup comdlg32.lib ole32.lib >t1
 ...
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\XCLYBWNT.LIB" tt.res @t1 @t2
 *
 *  4e) Compile with Microsoft Visual Studio .NET 2003 command line tools for Windows NT/2000/XP/Vista/7/8 32-Bit as:
 *
 ...
 *	    del xclibex2.obj
 *
 *	Or use the IDE, compiling xclibex2.cpp as a Windows NT/2000/XP/Vista/7/8 32-Bit app,
 *	using the XCLIBEX2.RC resource, linking to library(s):
 *	    for XCLIB:	      XCLIBWNT.LIB
 *	    for XCLIB+PXIPL:  XCLIBWNT.LIB PXIPLWNT.LIB
 ...
 *
 *  4f) Compile with Microsoft Visual Studio 2005 command line tools for Windows NT/2000/XP/Vista/7/8 32-Bit as:
 *
 ...
 *
 *  4g) Compile with Microsoft Visual C/C++ Vx.x for Windows XP/Vista/7/8 64-Bit):
 *
 *	    cl -I "\Program Files\EPIX\XCLIB" -c xclibex2.cpp
 *	    rc.exe /l 0x409 /fo tt.res "\Program Files\EPIX\XCLIB\xclibex2.rc"
 *	    echo -subsystem:windows -machine:X64 -entry:WinMainCRTStartup comdlg32.lib ole32.lib >t1
 ...
 *
 *  4i) Compile with Borland C++ V5.0 for Windows NT/2000/XP/Vista/7/8 32-Bit:	same as for
...
#define _CRT_SECURE_NO_DEPRECATE    1	// so newer Microsoft compilers don't
					// complain about perfectly
					// legitimate ANSI C functions
...
/*
 * Subroutine to display image. DON'T FUCK IT UP CHEN!!!
...
PIXCIDialogProc1(HWND hDlg, UINT wMsg, WPARAM wParam, LPARAM lParam)
{
	...
	if (pxd_infoModel(1) == PIXCI_A310 || pxd_infoModel(1) == PIXCI_A110) {
	    ShowWindow(GetDlgItem(hDlg, IDSVIDEO), SW_HIDE);
	    ShowWindow(GetDlgItem(hDlg, IDBNC1), SW_HIDE);
	    ShowWindow(GetDlgItem(hDlg, IDBNC2), SW_HIDE);
	    ShowWindow(GetDlgItem(hDlg, IDBNC3), SW_HIDE);
